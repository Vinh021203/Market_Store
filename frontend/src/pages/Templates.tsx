...
// ✨ Enhanced Loading Component với nhiều hiệu ứng hơn
const EnhancedLoadingSpinner = () => (
  <div className="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50 to-purple-50 dark:from-slate-900 dark:via-purple-900 dark:to-indigo-900 relative overflow-hidden">
    ...
    <div className="absolute inset-0">
      <div className="absolute top-0 left-0 w-full h-full bg-gradient-to-r from-blue-400/10 via-purple-400/10 to-pink-400/10 animate-gradient-x"></div>
      <div className="absolute top-0 left-0 w-96 h-96 bg-blue-400/20 rounded-full filter blur-3xl animate-pulse"></div>
      <div
        className="absolute bottom-0 right-0 w-96 h-96 bg-purple-400/20 rounded-full filter blur-3xl animate-pulse"
    ...
    <div className="fixed inset-0 overflow-hidden pointer-events-none">
      {[Code, Palette, Coffee, Rocket, Crown, Award].map((Icon, index) => (
        <motion.div
          key={index}
      ...
      <div className="flex flex-col items-center justify-center py-32 space-y-12">
        ...
        <div className="relative">
          <motion.div
            ...
            className="w-20 h-20 border-4 rounded-full border-gradient-to-r from-blue-500 to-purple-600 border-t-transparent"
          />
          <motion.div
            animate={{ rotate: -360 }}
            transition={{ duration: 1.5, repeat: Infinity, ease: "linear" }}
            className="absolute inset-2 w-16 h-16 border-4 rounded-full border-purple-300 border-r-transparent"
          />
          <div className="absolute inset-6 w-8 h-8 bg-gradient-to-r from-blue-500 to-purple-600 rounded-full"></div>
        </div>
        ...
        <div className="text-center space-y-6">
          ...
          >
            Đang tải kho templates tuyệt vời...
          </motion.h2>
          <motion.p
            initial={{ opacity: 0, y: 20 }}
            animate={{ opacity: 1, y: 0 }}
          ...
          >
            Chúng tôi đang chuẩn bị những template chất lượng cao nhất cho bạn
          </motion.p>
        </div>
        ...
        <div className="grid grid-cols-3 gap-8">
          {[Package, Code, Palette, Rocket, Award, Crown].map((Icon, index) => (
            <motion.div
              key={index}
              animate={{
                scale: [1, 1.3, 1],
...
// ✨ Enhanced Filter Sidebar với nhiều tính năng hơn
const EnhancedFilterSidebar = ({
  ...
  const popularTags = templateTags.slice(0, 8);
                    ...
                    <form onSubmit={handleSearch} className="space-y-3">
                      <div className="relative">
                        ...
                        <Input
                          ...
                          className="h-12 pl-12 bg-gradient-to-r from-white to-blue-50 dark:from-slate-800 dark:to-blue-900 border-2 border-blue-200 focus:border-blue-500"
                        />
                      ...
                      <Button
                        type="submit"
                        className="w-full h-11 bg-gradient-to-r from-blue-500 to-purple-600 hover:from-blue-600 hover:to-purple-700 shadow-lg hover:shadow-xl transition-all duration-300"
                      >
              ...
              <AnimatePresence>
                {expandedSections.sort && (
                  ...
                  >
                    ...
                    >
                      <SelectTrigger className="h-12 bg-gradient-to-r from-white to-purple-50 dark:from-slate-800 dark:to-purple-900 border-2 border-purple-200 focus:border-purple-500">
                        <SelectValue />
                      </SelectTrigger>
                      <SelectContent>
                      ...
                      {priceRanges.map((range, index) => (
                        ...
                        >
                          <Button
                            ...
                            className="w-full justify-start h-12 bg-gradient-to-r from-green-50 to-emerald-50 hover:from-green-100 hover:to-emerald-100 dark:from-green-900/20 dark:to-emerald-900/20"
                          >
            ...
            <div className="space-y-4">
              ...
              >
                <div className="flex items-center space-x-2">
                  ...
                  <span className="font-semibold text-lg">Công nghệ</span>
                </div>
                <div className="flex items-center space-x-2">
                  <Badge
                    variant="secondary"
...
// ✨ Enhanced Product Grid với nhiều view modes
const EnhancedProductGrid = ({
  ...
  <AnimatePresence mode="wait">
    {currentProducts.length > 0 ? (
      ...
      >
        <Card className="py-24 text-center border-0 shadow-2xl bg-gradient-to-br from-white via-blue-50 to-purple-50 dark:from-slate-800 dark:via-blue-900 dark:to-purple-900 overflow-hidden relative">
          ...
          <CardContent className="space-y-10 relative z-10">
            ...
            >
              <div className="relative">
                <Package className="w-32 h-32 mx-auto mb-6 text-muted-foreground" />
                <div className="absolute inset-0 bg-gradient-to-r from-blue-500 to-purple-600 opacity-20 rounded-full filter blur-xl"></div>
              </div>
            </motion.div>
            ...
            <div className="space-y-6">
              ...
              <p className="max-w-lg mx-auto text-xl text-muted-foreground leading-relaxed">
                Thử thay đổi bộ lọc hoặc từ khóa tìm kiếm để tìm thấy templates
            ...
            <div className="space-y-8">
              <div className="flex flex-col sm:flex-row gap-4 justify-center">
                <Button
                  ...
                  size="lg"
                  className="bg-gradient-to-r from-blue-500 to-purple-600 hover:from-blue-600 hover:to-purple-700 px-8 py-4 text-lg shadow-xl hover:shadow-2xl transition-all duration-300"
                >
              ...
              <div className="flex flex-wrap justify-center gap-4">
                {[
                  ...
                  >
                    <Badge
                      variant="outline"
                      className="px-4 py-2 text-sm cursor-pointer hover:bg-blue-50 dark:hover:bg-blue-900/20 transition-colors"
                    >
...
// ✨ Enhanced Header với stats animation
    ...
    <div className="flex flex-col lg:flex-row lg:items-center justify-between gap-6">
      <div className="flex items-center space-x-6">
        <motion.div
          ...
          className="flex items-center justify-center w-20 h-20 shadow-2xl rounded-3xl bg-gradient-to-br from-blue-500 via-purple-600 to-pink-600"
        >
          <Package className="w-10 h-10 text-white" />
        </motion.div>
        <div>
          <h1 className="text-6xl font-bold text-transparent bg-gradient-to-r from-blue-600 via-purple-600 to-pink-600 bg-clip-text mb-2">
            Templates
          </h1>
...
// ✨ Enhanced Scroll to Top với more features
        ...
        >
          ...
          <div className="relative">
            ...
            <motion.button
              ...
              whileTap={{ scale: 0.9 }}
              className="absolute inset-2 bg-gradient-to-r from-blue-500 to-purple-600 text-white rounded-full shadow-lg hover:shadow-xl transition-all duration-300 flex items-center justify-center"
            >
...
// ✨ Main Templates Component với tất cả enhancements
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50 to-purple-50 dark:from-slate-900 dark:via-purple-900 dark:to-indigo-900 relative overflow-hidden">
      ...
      <div className="fixed inset-0 overflow-hidden pointer-events-none">
        ...
        {/* Floating Icons */}
        {[Code, Palette, Coffee, Rocket, Crown, Award, Star, Heart].map(
          (Icon, index) => (
            <motion.div
              key={index}
              className="absolute"
            ...
            >
              <Icon className="w-6 h-6 text-blue-500/10" />
            </motion.div>
          ),
        )}
      </div>
            ...
            <AnimatePresence>
              {(filters.search ||
                ...
                <motion.div
                  ...
                  className="relative"
                >
                  <Card className="border-0 shadow-xl bg-gradient-to-r from-blue-50 via-purple-50 to-pink-50 dark:from-blue-900/20 dark:via-purple-900/20 dark:to-pink-900/20 overflow-hidden">
                              ...
                              <Badge className="text-green-800 bg-green-100 dark:bg-green-900 dark:text-green-200 px-4 py-2 text-sm">
                                ...
                                {(() => {
                                  ...
                                  if (min === 200000 && max === 500000)
                                    return "200K-500K";
                                  if (min === 500000) return "Trên 500K";
                                  return "Tất cả";
                                })()}
        ...
        <AnimatePresence>
          ...
          >
            ...
            <motion.button
              whileHover={{ scale: 1.1 }}
              whileTap={{ scale: 0.9 }}
              className="w-14 h-14 bg-pink-500 hover:bg-pink-600 text-white rounded-full shadow-lg hover:shadow-xl transition-all duration-300 flex items-center justify-center"
            >
            ...
            >
              <div className="p-6">
                <div className="flex items-center justify-between mb-6">
                  <h2 className="text-2xl font-bold">Bộ lọc thông minh</h2>
                  <Button
                    variant="ghost"
                    size="sm"
                    onClick={() => setShowFilters(false)}
                ...
                <div className="space-y-6">
                  ...
                  {/* Popular Tags */}
                  <div className="space-y-3">
                    <h3 className="font-semibold">Công nghệ phổ biến</h3>
                    <div className="flex flex-wrap gap-2">
                      {templateTags.slice(0, 10).map((tag) => (
                        <Badge
                          key={tag}
                          variant={
