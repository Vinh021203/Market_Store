              ...
              <div className="flex flex-col gap-6 lg:flex-row lg:items-center">
                ...
                <div className="flex-1">
                  <div className="flex flex-wrap items-center gap-3 mb-3">
                    ...
                    <Badge
                      className={`bg-white/30 backdrop-blur-md border-2 border-white/40 text-white px-4 py-1.5 shadow-xl`}
                    >
            ...
            <Tabs defaultValue="overview" className="space-y-6">
              ...
              >
                {[
                  ...
                  { value: "achievements", label: "Thành tích", icon: Trophy },
                    ...
                    <CardContent className="space-y-4">
                      <div className="space-y-2">
                        ...
                        <div className="flex justify-between text-xs text-slate-500 font-medium">
                          <span>{formatPrice(userStats?.totalSpent || 0)}</span>
                      ...
                      <div className="space-y-6 text-center">
                        ...
                        <div>
                          ...
                          <p className="text-sm text-slate-600 font-medium">
                            Thành viên {userStats?.membershipLevel} - Ưu đãi đặc
                            biệt
                          </p>
                        </div>
